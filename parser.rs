...
mod __parse__Term {
    ...
    //   Term = Num (*) [EOF]
    //
    //   EOF -> Reduce(Term = Num => ActionFn(1);)
    //
    pub fn __state1<
        'input,
        __TOKENS: Iterator<Item=Result<(usize, (usize, &'input str), usize),__ParseError<usize,(usize, &'input str),()>>>,
    ...
    //   __Term = Term (*) [EOF]
    //
    //   EOF -> Reduce(__Term = Term => ActionFn(0);)
    //
    pub fn __state2<
        'input,
        __TOKENS: Iterator<Item=Result<(usize, (usize, &'input str), usize),__ParseError<usize,(usize, &'input str),()>>>,
    ...
    //   Num = r#"[0-9]+"# (*) [EOF]
    //
    //   EOF -> Reduce(Num = r#"[0-9]+"# => ActionFn(3);)
    //
    pub fn __state4<
        'input,
        __TOKENS: Iterator<Item=Result<(usize, (usize, &'input str), usize),__ParseError<usize,(usize, &'input str),()>>>,
    ...
    //   Term = "(" Term ")" (*) [EOF]
    //
    //   EOF -> Reduce(Term = "(", Term, ")" => ActionFn(2);)
    //
    pub fn __state9<
        'input,
        __TOKENS: Iterator<Item=Result<(usize, (usize, &'input str), usize),__ParseError<usize,(usize, &'input str),()>>>,
